//#define SOUND_MANAGER // Van Sound_Manager a projektben
//#define CURSOR_MANAGER // Van Cursor_Manager a projektben
...
{
    /*
     * Gomb Akció egy World BoxCollider-en
     * */
    public class Button_Sprite : MonoBehaviour
    {
        ...
        void OnMouseDown()
        {
            if (!clickThroughUI && IsPointerOverUI()) return; // UI felett!
        ...
        void Awake()
        {
            if (GetWorldCamera == null) SetGetWorldCamera(() => Camera.main); // Beállítja az alap World Kamerát
