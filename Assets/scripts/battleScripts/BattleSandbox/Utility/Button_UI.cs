...
namespace DumbLuck.Utilities
{
    ...
    */
    ...
    public class Button_UI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        //Trigger-el minden másodpercben ha az egér felette van
        ...
        /*
         * Osztály egy gombművelet ideiglenes elfogására
         * Hasznos,ha a Tutorial-ban ki akarsz kapcsolni bizonyos gombokat
         * */
